...
## Table S6: Statistical analysis: first growing season (weeks 7–13)

```{r,echo=FALSE, message=FALSE, warning=FALSE}
# Filter first growing season data
df1 <- df %>%
  filter(timepoint %in% c(7, 11, 13))
df1$timepoint_c1 <- scale(df1$timepoint, center = TRUE, scale = FALSE)

# Mixed-effects model for first growing season
model <- lmer(TP ~ treatment * timepoint_c1 + (1 | pond), data = df1)
...
## Table S6: Statistical analysis: second growing season (weeks 59–63)

```{r,echo=FALSE, message=FALSE, warning=FALSE}
# Filter second growing season data
df2 <- df %>%
  filter(timepoint %in% c(59, 61, 63))
df2$timepoint_c2 <- scale(df2$timepoint, center = TRUE, scale = FALSE)

# Mixed-effects model for second growing season
model <- lmer(TP ~ treatment * timepoint_c2 + (1 | pond), data = df2)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
# PO4
model <- lmer(PO4 ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# NH4
model <- lmer(NH4 ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# TOC
model <- lmer(TOC ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# pH
model <- lmer(pH ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# Temperature
model <- lmer(Temp ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# O2
model <- lmer(O2pourcentage ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# Conductivity
model <- lmer(Cond ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)

# Light 
model <- lmer(light_weekly_mean ~ treatment * timepoint_c1 + (1 | pond), data = df1)
Anova(model, test = "F")
summary(model)
```
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
# PO4
model <- lmer(PO4 ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# NH4
model <- lmer(NH4 ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# TOC
model <- lmer(TOC ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# pH
model <- lmer(pH ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# Temperature
model <- lmer(Temp ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# O2
model <- lmer(O2pourcentage ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# Conductivity
model <- lmer(Cond ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)

# Light
model <- lmer(light_weekly_mean ~ treatment * timepoint_c2 + (1 | pond), data = df2)
Anova(model, test = "F")
summary(model)
```
