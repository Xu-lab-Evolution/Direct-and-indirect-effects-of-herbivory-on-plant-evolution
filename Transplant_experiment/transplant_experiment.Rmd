...
This R Markdown document analyzes the evolutionary and ecological responses of *Spirodela polyrhiza* to experimental snail herbivory, based on transplant experiments conducted in 2023 and 2024. It focuses on the relative growth rate of populations from different evolutionary backgrounds (control vs. herbivory ) when exposed to control or herbivory environments. The analyses support the generation of **Figure 3C** (main text) and **Figure S6** (supplementary material) in the manuscript.
...
## Figure 3C: data preparation and relative growth rate (2023)
...
px3C2023 <- ggplot(mdata.plot, aes(x = host_environment, y = fitness_av,
...
## Statistical analysis for figure 1C (2023)
...
## Figure 3C: data preparation and relative growth rate (2024)
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
px3C2024 <- ggplot(mdata.plot1, aes(x = host_environment, y = fitness_av,
                              color = origin_population)) +
...
## Statistical analysis for figure 1C (2024)
...
## Figure S6: data preparation for initial population 2023
...
## Figure S6: plot initial population 2023

```{r,echo=FALSE, message=FALSE, warning=FALSE}
pxS6 <- ggplot(mdata.plot2, aes(x = host_environment, y = fitness_av, 
                               color = origin_population)) +  
  geom_pointrange(
    aes(ymin = fitness_av - fitness_se, ymax = fitness_av + fitness_se),
    position = position_dodge(0.4),
...
## Statistical analysis for figure S6 (2023)
