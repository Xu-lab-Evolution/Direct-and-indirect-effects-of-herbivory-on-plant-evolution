...
- Running linear mixed-effects models to assess treatment effects at early and late timepoints for nutrient concentrations and physiochemical parameters .
  ...
  **Note:** This R Markdown document is used to generate **Figure 1D** in the manuscript, **Figure S5** and **Table S6** in the supplementary.
...
pxS5A <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = PO4_av, color = treatment)) +
...
pxS5B <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = NH4_av, color = treatment)) +
  theme_bw(base_size = 12) +
...
## --- Plot TOC ---
pxS5C <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = TOC_av, color = treatment)) +
  theme_bw(base_size = 12) +
...
## --- Plot pH ---
pxS5D <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = pH_av, color = treatment)) +
  theme_bw(base_size = 12) +
...
pxS5E <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = Cond_av, color = treatment)) +
  theme_bw(base_size = 12) +
...
pxS5F <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = O2_av, color = treatment)) +
  theme_bw(base_size = 12) +
...
pxS5G <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = Temp_av, color = treatment)) +
  theme_bw(base_size = 12) +
...
S5H <- ggplot(mdata.plot, aes(x = transform_x(timepoint), y = light_av, color = treatment)) +
  theme_bw(base_size = 12) +
