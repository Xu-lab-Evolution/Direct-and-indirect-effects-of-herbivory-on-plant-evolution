...
**Note:** This R Markdown document is used to generate **Figure 2C** in the manuscript, and **Figure S1C** in the supplementary
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
px2C <- ggplot(df3, aes(x = year, y = rel.count, fill = treatment)) +
