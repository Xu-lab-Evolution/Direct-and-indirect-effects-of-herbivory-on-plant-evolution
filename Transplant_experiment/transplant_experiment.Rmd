...
This R Markdown document analyzes the evolutionary and ecological responses of *Spirodela polyrhiza* to experimental snail herbivory, based on transplant experiments conducted in 2023 and 2024. It focuses on the relative growth rate of populations from different evolutionary backgrounds (control vs. herbivory ) when exposed to control or herbivory environments. The analyses support the generation of **Figure 3C** (main text) and **Figure S5** (supplementary material) in the manuscript.
